...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://dalli:December!999@localhost:5000/database.db'
...
def profile2():
    response = request.form.getlist("profile3")
    a = response[0]
    b = response[1]
    c = response[2]
    d = response[3]
